    ...
    <section>
      <div className="about">
        ...
        <div className="p-10 lg:w-1/2">
          <h1 className="mb-4 mt-8 text-4xl font-bold uppercase lg:mt-10">
            About Us
          </h1>
      ...
      <div className="m-2 flex flex-col gap-4 p-2 lg:grid lg:grid-cols-2">
        <div>
          ...
          <p>
            ...
            sustainable agriculture and ecological farming practices. We provide
            high-quality farm products, including fruits, vegetables, legumes,
            tubers, and cereals, as well as premium farm inputs to enhance farm
            yields.
          </p>
          <ul className="my-5">
